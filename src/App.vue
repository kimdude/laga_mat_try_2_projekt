<script setup>
  ...
  import Navigation from './router/components/Navigation.vue';
...
<template>
  ...
  <div class="container-fluid">
    ...
    <div class="row">
      <!-- Sidebar with nav -->
      <div class="col-12 col-md-3 col-lg-2 position-sticky bottom-0 position-md-static order-2 order-md-1 p-0 z-3" id="nav">
